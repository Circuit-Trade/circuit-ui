...
# Install drift-vaults
bun_install_and_link "drift-vaults/ts/sdk" "@drift-labs/sdk" "true"

# Install ui
bun_install_and_link "." "@drift/common @drift-labs/sdk @drift-labs/icons @drift-labs/react @drift-labs/vaults-sdk" ""
